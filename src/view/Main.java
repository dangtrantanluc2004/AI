...
public class Main extends JFrame implements MouseListener {
    ...
    public Main() {
        super("GAME CỜ VUA " + DuLieuCoVua.VERSION);
                ...
                while (true) {
                    switch (trangThai) {
                        ...
                        case DuLieuCoVua.MAY_DI:
                            ...
                            System.out.println("bước đi tốt nhất cho máy là ");
...
//			ThongTinPanel.hienThongBao();
            ...
            System.out.println("hien tai ddang luu " + lichSudichuyen.size() + "ban co");
...
//			}
    ...
    public void luuLichSuDi() {
        ...
        System.out.println("da luu ban cờ==============================");
